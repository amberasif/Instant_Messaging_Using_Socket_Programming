        ...
        while True:
            try:
                ...
                if message.startswith("FILE "):
                    ...
                    file.close()
                    image_path = r"C:\Users\amber\Instant_messaging_CN_Project\Image_from_Server.jpg"
                    self.display_message("Server", "Image Received", "#dcf8c6", "left")
                    self.display_received_image("Client", image_path)
                elif message == "VIDEO":
                    self.client_socket.settimeout(10)
                    try:
                        file_name = r"C:\Users\amber\Instant_messaging_CN_Project\Video_from_Server.mp4"
